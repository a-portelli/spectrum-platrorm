...
using Newtonsoft.Json;
    ...
    public class nodeData5
    {
        public _nodeData[] data { get; set; }
    }

    public class _nodeData5
    {
...
public class readNodeEW1 : MonoBehaviour
{
    //Declare variables
    ...
    void Start()
    {
        ...
        target.transform.localScale = new Vector3(0.1f, 0.1f, 0.1f); // 300,300,300
