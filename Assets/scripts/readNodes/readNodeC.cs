...
public class readNodeC : MonoBehaviour
{
    //Declare variables
    ...
    private void Awake() 
    {
        ...
        {
            //Create origin root 
            string oPath = "Assets/nodeC/";
            string oLinkRoot = "NodeC_";
            int x = b;
    ...
    void Start()
    {
       ...
       // Create and position the sphere. Reduce the size.
        ...
        for (int i = 2; i < 713; i++)
            {
                //Create root 
                string path = "Assets/nodeC/";
                string linkRoot = "NodeC_";
                int x = i;
